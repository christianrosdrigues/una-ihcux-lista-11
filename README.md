...
Proposta de valor
O aplicativo ReCiclo conecta pessoas que desejam doar itens com pessoas que precisam, promovendo sustentabilidade e redução de desperdício.
...
2. Navega pelo feed ou  cadastra algum item.
3. faz buscas por filtro.
4. seleciona um item.
5. Entra em contato via chat.
6. Combina a retirada.
7. Conclui a doação / interesse.
